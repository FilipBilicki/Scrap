...
def parse_article(self, response: scrapy.http.Response):
    article = ArticleItem()
    article['title'] = response.xpath('//*[@id="p-content-specification"]/div[2]/h3/text()').get()
    article['model'] = response.xpath('//*[@id="p-content-specification"]/div[2]/div/div[2]/table/tbody/tr[3]').get()
